package com.gmail.val59000mc.playuhc.mc1_13.maploader;

import com.gmail.val59000mc.playuhc.mc1_13.configuration.GenerateVeinConfiguration;
import com.gmail.val59000mc.playuhc.mc1_13.game.GameManager;
import com.gmail.val59000mc.playuhc.mc1_13.utils.RandomUtils;
...
public class VeinGenerator {
	...
	private Block tryAdjustingToProperBlock(Block randBlock) {
		...
		if(randBlock.getType().equals(Material.WATER)){
			while(randBlock.getType().equals(Material.WATER) && randBlock.getY() > 10){
