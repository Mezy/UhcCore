package com.gmail.val59000mc.playuhc.mc1_8.scoreboard;
...
import com.gmail.val59000mc.playuhc.mc1_8.players.*;
...
public class ScoreboardManager {
    ...
    public void setUpPlayerScoreboard(UhcPlayer scoreboardPlayer){
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(PlayUhc.getPlugin(),new UpdateScoreboardThread(scoreboardPlayer),1L);
    }
    ...
    public String translatePlaceholders(String s, UhcPlayer uhcPlayer, Player bukkitPlayer, ScoreboardType scoreboardType){
        ...
        if (returnString.length() > 32){
            Bukkit.getLogger().warning("[PlayUHC] Scoreboard line is too long: '" + returnString + "'!");
            returnString = "";
        }
