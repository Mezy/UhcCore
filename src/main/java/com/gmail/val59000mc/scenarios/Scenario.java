...
public enum Scenario{
    ...
    RANDOMIZEDITEMS("Randomized Items", UniversalMaterial.EXPERIENCE_BOTTLE, RandomizedItemsListener.class, "&6Randomized Items&7:", "&7- Every block broken will drop random items." ),
