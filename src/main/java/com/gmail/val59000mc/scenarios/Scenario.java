...
public enum Scenario{
    ...
    RANDOMITEMS("Random Items", UniversalMaterial.EXPERIENCE_BOTTLE, RandomizedBlockDropsListener.class, "&Random Drops!&7:", "&7-Every block will drop a random item when broken." ),
